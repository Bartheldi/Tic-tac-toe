...
if(flagCol2Box1 == 1 && flagCol3Box1 == 1 && flagCol4Box1 == 1 && flagCol5Box1 == 1 || flagCol2Box2 == 1 && flagCol3Box3 == 1 && flagCol4Box4 == 1 && flagCol5Box5 == 1 || flagCol1Box2 == 1 && flagCol1Box3 == 1 && flagCol1Box4 == 1 && flagCol1Box5 == 1) {
    ...
    if(flagCol2Box1 == 1 && flagCol3Box1 == 1 && flagCol4Box1 == 1 && flagCol5Box1 == 1) {       
        ...
        if(winner === true){ pomWinner = winner}
    } 
...
if(flagCol1Box2 == 1 && flagCol3Box2 == 1 && flagCol4Box2 == 1 && flagCol5Box2 == 1) {  
    ...
    if(winner === true){ pomWinner = winner}//nove
...
checkPossibleTie(pomWinner) //nove
